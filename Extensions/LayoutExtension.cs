...
{
    public class VBXLayoutExtension : EntityLayoutManager
    {
        public new static string CurrentLayoutPath => $@"{new FileInfo(VBXProject.CurrentProject.Location).Directory}\Vbx\";
        ...
        public VBXLayoutExtension(INodeWrangler nodeWrangler) : base(nodeWrangler)
        {
